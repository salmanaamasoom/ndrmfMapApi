...
@CrossOrigin
@RepositoryRestResource(excerptProjection = UnionCouncil.class)
public interface UnionCouncilRepository extends JpaRepository<UnionCouncil, Long> {

    List<UnionCouncil> findByProvinceProvinceIdAndDistrictIdAndTehsilTehsilId(Long provinceId,Long districtId, Long tehsilId);
